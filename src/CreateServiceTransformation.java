public class CreateServiceTransformation {
    public static void createTransformationTemplates() {
        ...
        DealingWithFiles.writeToFile(Constants.beginXSL+GetMapping.Execute(Constants.XMLFilesfixedPath+Constants.serviceName+"\\RequestInput.xml",Constants.XMLFilesfixedPath+Constants.serviceName+"\\RequestOutput.xml")+Constants.endXSL,Constants.serviceFilesPath+Constants.serviceName+"/TRANSFORMATION/SABB-"+Constants.backendName+"-"+Constants.serviceName+"-Rq.xsl");
        DealingWithFiles.writeToFile(Constants.beginXSL+GetMapping.Execute(Constants.XMLFilesfixedPath+Constants.serviceName+"\\ResponseInput.xml",Constants.XMLFilesfixedPath+Constants.serviceName+"\\ResponseOutput.xml")+Constants.endXSL,Constants.serviceFilesPath+Constants.serviceName+"/TRANSFORMATION/SABB-"+Constants.backendName+"-"+Constants.serviceName+"-Rs.xsl");
